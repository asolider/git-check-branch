...
// 服务器列表
func (ctl *serverController) serverList(c *gin.Context) {
...
// 添加服务器
func (ctl *serverController) serverAdd(c *gin.Context) {
...
// 删除服务器
func (ctl *serverController) serverDel(c *gin.Context) {
...
// 服务器信息
func (ctl *serverController) serverInfo(c *gin.Context) {
	var serverID = c.Query("server_id")
	if serverID == "" {
		c.JSON(http.StatusOK, formatReturn(false, nil, "id 必传"))
		return
...
// 服务器编辑
func (ctl *serverController) serverEdit(c *gin.Context) {
	var server serverItem
